...
contract $BUD_LOTTO {
    ...
    uint256 public buybackPercent = 50;
    uint256 public marketPercent = 50;
    ...
    constructor(address payable _owner) {
        BuyBackandBurn = payable(0x70d65b87F2E3e189C4A21b8E0Df5334C78b5baDe);
        marketWallet = payable(0x70d65b87F2E3e189C4A21b8E0Df5334C78b5baDe);
        owner = _owner;
    ...
    function getWinnersArrLength() public view returns(uint count) {
    ...
    function Lottery() public onlyOwner {
        ...
        User storage user = userData[winner];
        user.winCount++;
    ...
    function ResetStuckTimer() public onlyOwner {
        startTime = block.timestamp;
        endTime = startTime.add(timePeriod);
    }
